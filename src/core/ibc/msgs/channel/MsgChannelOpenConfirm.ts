...
> {
  ...
  public static fromData(data: MsgChannelOpenConfirm.Data): MsgChannelOpenConfirm {
  ...
  public static fromProto(proto: MsgChannelOpenConfirm.Proto): MsgChannelOpenConfirm {
    return new MsgChannelOpenConfirm(
      proto.portId,
      proto.channelId,
