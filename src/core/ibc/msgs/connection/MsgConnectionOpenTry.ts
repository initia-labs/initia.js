...
> {
  ...
  public static fromData(data: MsgConnectionOpenTry.Data): MsgConnectionOpenTry {
    const {
      client_id,
  ...
  public static fromProto(proto: MsgConnectionOpenTry.Proto): MsgConnectionOpenTry {
    return new MsgConnectionOpenTry(
      proto.clientId,
