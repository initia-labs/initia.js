...
import { MsgRegisterCounterpartyAddress as MsgRegisterCounterpartyAddress_pb } from '@initia/initia.proto/ibc/applications/fee/v1/tx';
...
> {
  ...
  public static fromAmino(_: any): MsgRegisterCounterpartyAddress {
    _;
  ...
  public static unpackAny(msgAny: Any): MsgRegisterCounterpartyAddress {
